      ...
      <div className="p-12">
        ...
        <section>
          ...
          <p className="leading-snug text-lg">
            <a href="https://github.com/theRamenWithin/" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">Github</a> / <a href="https://alexpike.work/docs/alex_pike_resume.pdf" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Resume</a> / <a href="https://www.linkedin.com/in/alex-pike-ap/" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">LinkedIn</a> / <a href="https://twitter.com/theramenwithin/" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">Twitter</a>
          </p>
        </section>
          ...
          <section className="flex flex-wrap justify-between mt-6 text-lg">
            ...
            <div className="max-w-sm mb-6">
              ...
              <section className="mt-2">
                <p>A <b>React</b> front-end, utilising Material UI, with a <b>Ruby on Rails</b> API back-end, reponding to axios requests. This project was part of my group, final assignment at Coder Academy.</p>
            ...
            <div className="max-w-sm mb-6">
              ...
              <section className="mt-2">
                <p>A <b>Ruby on Rails</b> application, utilising <b>JavaScript</b> with the Twilio library. This project was the last assignment of my second term at Coder Academy.</p>
            ...
            <div className="max-w-sm mb-6">
              ...
              <section className="mt-2">
                <p>A fully <b>Ruby on Rails</b> application, created as part of 3-day hackaton at Coder Academy in a team of 3 collaborating over <b>Git</b>.</p>
            ...
            <div className="max-w-sm mb-6">
              ...
              <section className="mt-2">
                <p>A <b>Ruby</b> terminal application, utilising third-party gems. This project was the last assignment of my first term at Coder Academy.</p>
            ...
            <div className="max-w-sm mb-6">
              ...
              <section className="mt-2">
                <p>A portfolio website written in vanilla <b>HTML5</b> & <b>CSS3</b>. This project was the second assignment of my first term at Coder Academy and the first website I ever made.</p>
              </section>
              <section className="mt-2">
